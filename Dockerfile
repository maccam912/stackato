...
RUN wget http://www.activestate.com/stackato/download_client/thank-you?dl=http://downloads.activestate.com/stackato/client/v3.1.1/stackato-3.1.1-linux-glibc2.3-x86_64.zip

RUN unzip stackato*

RUN export PATH=$(pwd)/stackato;$PATH
